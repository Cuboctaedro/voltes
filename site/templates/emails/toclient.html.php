...
<html>
  <head>
    ...
    <title>Κράτηση - <?= $page->parent()->title(); ?></title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <?php else: ?>
                        <p><span class="bold">Αριθμός ενηλίκων:</span> <?= $data['adult_number']; ?></p>
                        <p><span class="bold">Αριθμός εφήβων:</span> <?= $data['teen_number']; ?></p>
                    <?php endif; ?>
                        <p><span class="bold">Μήνυμα:</span> <?=  $data['client_message']; ?></p>
                        <p><span class="bold">Τρόπος πληρωμής:</span>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="<?= url($page->url() . '/info') ?>" target="_blank">πληροφορίες ραντεβού</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
